...
#api_url = "http://144.202.75.241/cgi-bin/getLastVolts.py"
...
base_path = "~/veriumMiner/cpuminer -o stratum+tcp://vrm.n3rd3d.com:3333 -u Longhorn.solar_test_server -p 1234 --api-bind 0.0.0.0:4048 -t"
#base_path = "/root/veriumMiner/cpuminer -o stratum+tcp://vrm.n3rd3d.com:3333 -u Longhorn.d1_test_server -p 1234 --api-bind 0.0.0.0:4048 -t"
	...
	while True:
		...
		if(float(battery_volts) >= MAX_VOLTS):
			...
			if maxThreads:
			  ...
			  proc_id = process_id
		if((float(battery_volts) > MIN_VOLTS) and (float(battery_volts) <= AVG_VOLTS)):
			if maxThreads:
				...
				maxThreads = False
				time.sleep(5)
				print "Starting cpu miner with BASE_THREAD_COUNT"
